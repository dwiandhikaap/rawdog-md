...
case $platform in
    'Darwin x86_64')
        target="darwin-amd64"
        asset_name="rawd-v0.1.4-darwin-amd64.tar.gz"
        ;;
    'Darwin arm64')
        target="darwin-arm64"
        asset_name="rawd-v0.1.4-darwin-arm64.tar.gz"
        ;;
    'Linux x86_64')
        target="linux-amd64"
        asset_name="rawd-v0.1.4-linux-amd64.tar.gz"
        ;;
    'Linux aarch64')
        target="linux-arm64"
        asset_name="rawd-v0.1.4-linux-arm64.tar.gz"
        ;;
    *)
